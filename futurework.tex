...
%  Researching as much as possible the potential for code extraction should provide more depth to the analysis made by this project and should comprise the majority of the remaining time spent. 
